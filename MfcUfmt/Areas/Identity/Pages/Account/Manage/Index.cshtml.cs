        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.Email != email)
            {
                ...
                if (!setEmailResult.Succeeded)
                {
                    ...
                    throw new InvalidOperationException($"Ocorreu um erro inesperado ao configurar o email para o usuário com ID '{userId}'.");
                }
            }
            ...
            if (Input.PhoneNumber != phoneNumber)
            {
                ...
                {
                    var userId = await _userManager.GetUserIdAsync(user);
                    throw new InvalidOperationException($"Ocorreu um erro inesperado ao configurar o número de telefone do usuário com ID '{userId}'.");
                }
            }
